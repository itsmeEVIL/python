...
# input / lower button
button_1 = Button(lower_frame, text="1", font=("roboto", 18), bg="#7998AC", fg="#f2f2f2", activebackground="#61869e", activeforeground="#f2f2f2", relief="flat", command=lambda:press(1)).place(relx=0, rely=0, relwidth=0.25, relheight=0.25)
button_2 = Button(lower_frame, text="2", font=("roboto", 18), bg="#7998AC", fg="#f2f2f2", activebackground="#61869e", activeforeground="#f2f2f2", relief="flat", command=lambda:press(2)).place(relx=0.25, rely=0, relwidth=0.25, relheight=0.25)
button_3 = Button(lower_frame, text="3", font=("roboto", 18), bg="#7998AC", fg="#f2f2f2", activebackground="#61869e", activeforeground="#f2f2f2", relief="flat", command=lambda:press(3)).place(relx=0.50, rely=0, relwidth=0.25, relheight=0.25)
button_plus = Button(lower_frame, text="+", font=("roboto", 18), bg="#7998AC", fg="#f2f2f2", activebackground="#61869e", activeforeground="#f2f2f2", relief="flat", command=lambda:press("+")).place(relx=0.75, rely=0, relwidth=0.25, relheight=0.25)
button_4 = Button(lower_frame, text="4", font=("roboto", 18), bg="#7998AC", fg="#f2f2f2", activebackground="#61869e", activeforeground="#f2f2f2", relief="flat", command=lambda:press(4)).place(relx=0, rely=0.25, relwidth=0.25, relheight=0.25)
button_5 = Button(lower_frame, text="5", font=("roboto", 18), bg="#7998AC", fg="#f2f2f2", activebackground="#61869e", activeforeground="#f2f2f2", relief="flat", command=lambda:press(5)).place(relx=0.25, rely=0.25, relwidth=0.25, relheight=0.25)
button_6 = Button(lower_frame, text="6", font=("roboto", 18), bg="#7998AC", fg="#f2f2f2", activebackground="#61869e", activeforeground="#f2f2f2", relief="flat", command=lambda:press(6)).place(relx=0.50, rely=0.25, relwidth=0.25, relheight=0.25)
button_minus = Button(lower_frame, text="-", font=("roboto", 18), bg="#7998AC", fg="#f2f2f2", activebackground="#61869e", activeforeground="#f2f2f2", relief="flat", command=lambda:press("-")).place(relx=0.75, rely=0.25, relwidth=0.25, relheight=0.25)
button_7 = Button(lower_frame, text="7", font=("roboto", 18), bg="#7998AC", fg="#f2f2f2", activebackground="#61869e", activeforeground="#f2f2f2", relief="flat", command=lambda:press(7)).place(relx=0, rely=0.50, relwidth=0.25, relheight=0.25)
